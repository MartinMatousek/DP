...
parser.add_argument("--main_dir", default="none", help="main_dir")
parser.add_argument(
    "--n_save_ex", type=int, default=50, help="Number of audio examples to save, -1 means all"
)
parser.add_argument("--speakers", type=int, default=2, help="nohelp")

compute_metrics = ["si_sdr", "sdr", "sir", "sar", "stoi"]


def main(conf):
    model_path="exp/" + conf["main_dir"] + "/best_model.pth"
...
if __name__ == "__main__":
    ...
    conf_path = args.main_dir
    conf_path = "exp/" + args.main_dir + "/conf.yml"
    ...
    arg_dic["main_dir"] = args.main_dir
    main(arg_dic)
