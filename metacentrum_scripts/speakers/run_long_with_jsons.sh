...
DATADIR=/storage/brno2/home/martin_matousek 
...
tar -xf $SCRATCHDIR/data/convtasnet.tar -C $SCRATCHDIR/data/

mkdir $SCRATCHDIR/data/wav8k

cp $DATADIR/data/min.tar $SCRATCHDIR/data/wav8k/
tar -xf $SCRATCHDIR/data/wav8k/min.tar -C $SCRATCHDIR/data/wav8k/
...
# conda create --prefix=/storage/brno2/home/martin_matousek/conda/dp_mm python=3.8
conda activate /storage/brno2/home/martin_matousek/conda/dp_mm
export PATH=/storage/brno2/home/martin_matousek/conda/dp_mm/bin:$PATH
...
bash data/convtasnet/run_diff_speaker_count.sh
